  include "fftpack/cfft1b.f90"
  include "fftpack/cfft1f.f90"
  include "fftpack/cfft1i.f90"
  !
  include "fftpack/c1f2kb.f90"
  include "fftpack/c1f2kf.f90"
  include "fftpack/c1f3kb.f90"
  include "fftpack/c1f3kf.f90"
  include "fftpack/c1f4kb.f90"
  include "fftpack/c1f4kf.f90"
  include "fftpack/c1f5kb.f90"
  include "fftpack/c1f5kf.f90"
  include "fftpack/c1fgkb.f90"
  include "fftpack/c1fgkf.f90"
  include "fftpack/c1fm1b.f90"
  include "fftpack/c1fm1f.f90"
  include "fftpack/r8_factor.f90"
  include "fftpack/r8_mcfti1.f90"
  include "fftpack/r8_tables.f90"
  include "fftpack/xerfft.f90"
  ...
  contains
    ...
    !*********************************************************************
    !        MATSUBARA (IMAGINARY) FREQUENCY - IMAGINARY TIME
    !  these routines perform the direct (frequency to time) and inverse
    !  (time to frequency) Fourier Transform for a Green's function.
    !*********************************************************************
    !                       FORWARD (Freq. --> Time) TRANSFORM
    !+-------------------------------------------------------------------+
    !PURPOSE  : Evaluate the FFT of a given function from Matsubara frequencies
    ! to imaginary time. The routine implements all the necessary manipulations
    ! required by the FFT in this formalism: tail subtraction and reshaping. 
